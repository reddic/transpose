	...
	function Encrypt() {
	    ...
	    if(key <= 1){ alert("masukan kata kunci minimal 2 karakter atau lebih"); return; }
	    if(pc=="") pc = "x";    
	...
	function Decrypt(f) {
	    ...
	    klen = keyword.length;
	    if(klen <= 1){ alert("masukan kata kunci minimal 2 karakter atau lebih"); return; }
	    if(ciphertext.length % klen != 0){ alert("ciphertext belum diisi,atau kata kunci salah?."); }
